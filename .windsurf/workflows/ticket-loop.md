---
description: Executa o ciclo completo de um ticket — triagem → implementação → code review → validação de QA — com handoffs e logs a…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /ticket-loop

Executa o ciclo completo de um ticket — triagem → implementação → code review → validação de QA — com handoffs e logs a cada etapa, em loop até todos os critérios de aceite passarem, o ticket bloquea…

## Passos

1. Abra e leia integralmente `.claude/skills/ticket-loop/SKILL.md` neste repositório — ele contém o procedimento
