---
description: Revisa criticamente uma spec (docs/specs/<slug>/) antes da aprovação — completude, critérios de aceite verificáveis, re…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /spec-review

Revisa criticamente uma spec (docs/specs/<slug>/) antes da aprovação — completude, critérios de aceite verificáveis, requisitos do projeto contemplados, riscos e escopo. Usar antes de liberar qualque…

## Passos

1. Abra e leia integralmente `.claude/skills/spec-review/SKILL.md` neste repositório — ele contém o procedimento
