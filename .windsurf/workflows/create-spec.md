---
description: Inicia trabalho novo pelo fluxo Spec-Driven Development em docs/specs/<slug>/ — spec.md (o quê/por quê) → plan.md (como…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /create-spec

Inicia trabalho novo pelo fluxo Spec-Driven Development em docs/specs/<slug>/ — spec.md (o quê/por quê) → plan.md (como) → tasks.md (passos executáveis). Usar antes de qualquer implementação de funci…

## Passos

1. Abra e leia integralmente `.claude/skills/create-spec/SKILL.md` neste repositório — ele contém o procedimento
