---
description: Cria um nó de conteúdo completo na taxonomia (content/<stage>/<area>/<topic>/[<subtopic>]) com meta.json, teoria bilíng…
---
...
1. Abra e leia integralmente `.claude/skills/new-topic/SKILL.md` neste repositório — ele contém o procedimento
