---
description: Classifica a tarefa recebida e define a cadeia mínima de agents do /dev-loop (quais etapas rodam, quais agents, o que r…
---
...
1. Abra e leia integralmente `.claude/agents/task-router.md` — ele define o papel, o escopo exclusivo, os
   limites e o que este agente **não** faz.
2. Leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/task-router.md`, o contexto da área
...
6. Ao concluir, atualize `memory/agents/task-router.md` e registre lições em
