---
description: Audita a aplicação como PWA — instalabilidade, funcionamento offline, performance (Core Web Vitals), tamanho de bundle…
---
...
1. Abra e leia integralmente `.claude/skills/pwa-audit/SKILL.md` neste repositório — ele contém o procedimento
