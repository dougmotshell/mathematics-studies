---
description: Cria um ticket de desenvolvimento no fluxo de agentes — coleta o pedido, gera tickets/TCK-NNNN-<slug>/ (ticket.md + log…
---
...
1. Abra e leia integralmente `.claude/skills/ticket/SKILL.md` neste repositório — ele contém o procedimento
