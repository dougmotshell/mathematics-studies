---
description: Cria um conjunto de exercícios ou uma avaliação para um nó de conteúdo, com gradiente de dificuldade, feedback diagnóst…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /new-exercise-set

Cria um conjunto de exercícios ou uma avaliação para um nó de conteúdo, com gradiente de dificuldade, feedback diagnóstico por alternativa, dicas progressivas e metadados. Usar para popular exercises…

## Passos

1. Abra e leia integralmente `.claude/skills/new-exercise-set/SKILL.md` neste repositório — ele contém o procedimento
