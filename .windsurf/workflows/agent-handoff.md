---
description: Transfere uma tarefa em andamento entre CLIs (Claude Code, Codex, Copilot, Gemini) usando .agent-handoff.md como contra…
---
...
1. Abra e leia integralmente `.claude/skills/agent-handoff/SKILL.md` neste repositório — ele contém o procedimento
