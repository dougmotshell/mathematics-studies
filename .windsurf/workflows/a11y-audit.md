---
description: Audita acessibilidade da plataforma e do conteúdo — WCAG 2.2 AA, matemática acessível a leitor de tela, navegação por t…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /a11y-audit

Audita acessibilidade da plataforma e do conteúdo — WCAG 2.2 AA, matemática acessível a leitor de tela, navegação por teclado, contraste, foco e alternativas textuais. Usar antes de publicar interfac…

## Passos

1. Abra e leia integralmente `.claude/skills/a11y-audit/SKILL.md` neste repositório — ele contém o procedimento
