---
description: Cuida de CI/CD, build, deploy na Vercel, previews, variáveis de ambiente, monitoramento e performance de entrega. Usar…
---
...
1. Abra e leia integralmente `.claude/agents/devops-engineer.md` — ele define o papel, o escopo exclusivo, os
   limites e o que este agente **não** faz.
2. Leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/devops-engineer.md`, o contexto da área
...
6. Ao concluir, atualize `memory/agents/devops-engineer.md` e registre lições em
