---
description: Desenha uma trilha de aprendizado — sequência de nós de conteúdo com objetivo, pré-requisitos, marcos, avaliações e cri…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /learning-path

Desenha uma trilha de aprendizado — sequência de nós de conteúdo com objetivo, pré-requisitos, marcos, avaliações e critério de conclusão. Usar para criar percursos por objetivo do aluno (ex.: "do ze…

## Passos

1. Abra e leia integralmente `.claude/skills/learning-path/SKILL.md` neste repositório — ele contém o procedimento
