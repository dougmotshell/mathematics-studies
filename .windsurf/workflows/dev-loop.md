---
description: Executa um loop de desenvolvimento com handoff automático entre agents — cada agente produz um briefing compacto que é…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /dev-loop

Executa um loop de desenvolvimento com handoff automático entre agents — cada agente produz um briefing compacto que é a única entrada do agente seguinte. Usar quando uma tarefa se beneficiar de rote…

## Passos

1. Abra e leia integralmente `.claude/skills/dev-loop/SKILL.md` neste repositório — ele contém o procedimento
