---
description: Regenera memory/context/project-context.md com o estado atual do projeto — o que existe, o que está decidido, o que est…
---
<!-- managed-by:mathematics-studies/sync-ai-adapters -->

# /generate-project-context

Regenera memory/context/project-context.md com o estado atual do projeto — o que existe, o que está decidido, o que está em aberto e quais são os próximos passos. Usar após marcos, decisões aceitas o…

## Passos

1. Abra e leia integralmente `.claude/skills/generate-project-context/SKILL.md` neste repositório — ele contém o procedimento
