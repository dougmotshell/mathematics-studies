...
Assuma o papel definido em [`.claude/agents/math-reviewer.md`](../../.claude/agents/math-reviewer.md) e siga integralmente suas
...
- **Antes da tarefa:** ler `memory/MEMORY.md`, `memory/agents/math-reviewer.md`, o contexto da área
  em `memory/context/` e `docs/errors/README.md`.
- **Ao concluir tarefa significativa:** atualizar `memory/agents/math-reviewer.md` (notas
