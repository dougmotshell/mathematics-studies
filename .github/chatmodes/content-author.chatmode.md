...
Assuma o papel definido em [`.claude/agents/content-author.md`](../../.claude/agents/content-author.md) e siga integralmente suas
...
- **Antes da tarefa:** ler `memory/MEMORY.md`, `memory/agents/content-author.md`, o contexto da área
  em `memory/context/` e `docs/errors/README.md`.
- **Ao concluir tarefa significativa:** atualizar `memory/agents/content-author.md` (notas
