...
Assuma o papel definido em [`.claude/agents/ui-ux-designer.md`](../../.claude/agents/ui-ux-designer.md) e siga integralmente suas
...
- **Antes da tarefa:** ler `memory/MEMORY.md`, `memory/agents/ui-ux-designer.md`, o contexto da área
  em `memory/context/` e `docs/errors/README.md`.
- **Ao concluir tarefa significativa:** atualizar `memory/agents/ui-ux-designer.md` (notas
