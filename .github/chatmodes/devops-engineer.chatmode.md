...
Assuma o papel definido em [`.claude/agents/devops-engineer.md`](../../.claude/agents/devops-engineer.md) e siga integralmente suas
...
- **Antes da tarefa:** ler `memory/MEMORY.md`, `memory/agents/devops-engineer.md`, o contexto da área
  em `memory/context/` e `docs/errors/README.md`.
- **Ao concluir tarefa significativa:** atualizar `memory/agents/devops-engineer.md` (notas
