---
mode: agent
description: Registra um erro não-trivial em docs/errors/ para não repeti-lo — comando que falhou por causa evitável, afirmação matemática errada publicada, suposição equivocada sobre a taxonomia ou retrabalho po…
---
<!-- managed-by:mathematics-studies/sync-slash-commands -->

Leia e siga integralmente as instruções da skill em [`.claude/skills/log-error/SKILL.md`](../../.claude/skills/log-error/SKILL.md).
