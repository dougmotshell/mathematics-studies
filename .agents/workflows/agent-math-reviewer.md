...
1. Abra e leia integralmente `.claude/agents/math-reviewer.md` — ele define o papel, o escopo exclusivo, os
   limites e o que este agente **não** faz.
2. Leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/math-reviewer.md`, o contexto da área
...
6. Ao concluir, atualize `memory/agents/math-reviewer.md` e registre lições em
