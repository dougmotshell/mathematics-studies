...
1. Abra e leia integralmente `.claude/agents/ui-ux-designer.md` — ele define o papel, o escopo exclusivo, os
   limites e o que este agente **não** faz.
2. Leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/ui-ux-designer.md`, o contexto da área
...
6. Ao concluir, atualize `memory/agents/ui-ux-designer.md` e registre lições em
