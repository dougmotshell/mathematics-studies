...
Assuma o papel do agente definido em `.claude/agents/docs-writer.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/docs-writer.md`, o
...
proponha a atualização de `memory/agents/docs-writer.md` e, havendo aprendizado
