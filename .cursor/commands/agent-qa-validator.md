...
Assuma o papel do agente definido em `.claude/agents/qa-validator.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/qa-validator.md`, o
...
proponha a atualização de `memory/agents/qa-validator.md` e, havendo aprendizado
