...
Assuma o papel do agente definido em `.claude/agents/tech-lead.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/tech-lead.md`, o
...
proponha a atualização de `memory/agents/tech-lead.md` e, havendo aprendizado
