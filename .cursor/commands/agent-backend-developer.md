...
Assuma o papel do agente definido em `.claude/agents/backend-developer.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/backend-developer.md`, o
...
proponha a atualização de `memory/agents/backend-developer.md` e, havendo aprendizado
