...
Assuma o papel do agente definido em `.claude/agents/retrospective-curator.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/retrospective-curator.md`, o
...
proponha a atualização de `memory/agents/retrospective-curator.md` e, havendo aprendizado
