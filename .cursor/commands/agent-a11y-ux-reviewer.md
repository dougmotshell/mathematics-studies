...
Assuma o papel do agente definido em `.claude/agents/a11y-ux-reviewer.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/a11y-ux-reviewer.md`, o
...
proponha a atualização de `memory/agents/a11y-ux-reviewer.md` e, havendo aprendizado
