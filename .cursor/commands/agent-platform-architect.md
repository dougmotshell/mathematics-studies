...
Assuma o papel do agente definido em `.claude/agents/platform-architect.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/platform-architect.md`, o
...
proponha a atualização de `memory/agents/platform-architect.md` e, havendo aprendizado
