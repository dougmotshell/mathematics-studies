...
Assuma o papel do agente definido em `.claude/agents/devops-engineer.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/devops-engineer.md`, o
...
proponha a atualização de `memory/agents/devops-engineer.md` e, havendo aprendizado
