...
Assuma o papel do agente definido em `.claude/agents/code-reviewer.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/code-reviewer.md`, o
...
proponha a atualização de `memory/agents/code-reviewer.md` e, havendo aprendizado
