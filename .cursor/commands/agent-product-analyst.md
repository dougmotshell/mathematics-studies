...
Assuma o papel do agente definido em `.claude/agents/product-analyst.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/product-analyst.md`, o
...
proponha a atualização de `memory/agents/product-analyst.md` e, havendo aprendizado
