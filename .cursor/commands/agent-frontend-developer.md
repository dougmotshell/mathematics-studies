...
Assuma o papel do agente definido em `.claude/agents/frontend-developer.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/frontend-developer.md`, o
...
proponha a atualização de `memory/agents/frontend-developer.md` e, havendo aprendizado
