...
Assuma o papel do agente definido em `.claude/agents/exercise-designer.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/exercise-designer.md`, o
...
proponha a atualização de `memory/agents/exercise-designer.md` e, havendo aprendizado
