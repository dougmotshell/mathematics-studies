...
Assuma o papel do agente definido em `.claude/agents/content-author.md` deste repositório e siga integralmente
suas instruções, limites, escopo exclusivo e fontes.

Antes de agir, leia `AGENTS.md`, `memory/MEMORY.md`, `memory/agents/content-author.md`, o
...
proponha a atualização de `memory/agents/content-author.md` e, havendo aprendizado
